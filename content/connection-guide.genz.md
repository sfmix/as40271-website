...
We're built for **local eyeball networks**: residential, community, municipal and small-business ISPs whose users are in the San Francisco Bay Area. If most of your traffic is headed for end-users on consumer devices, you're our people.
...
Expect **tens of percent** of your downstream bytes to land on AS40271 once it's hot — exact figures depend on your subscriber mix. Steam patch days, Apple OS releases, Windows Update rollouts, and big YouTube events will all spike, no cap. Set capacity accordingly.

You'll get the `tech-c@sfmix.org` mailing list, a phone number for actual humans, and a seat in our planning convos about which content sources to chase next.
